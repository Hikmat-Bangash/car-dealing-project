    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.cards}>
          ...
          <div className={styles.card}>
            ...
            <ul className={styles.cardUl}>
              <li style={{ fontWeight: "bold", color: "#6C757D" }} className={styles.head}>
                HÄNDLERBEREICH
              </li>
          ...
          <div className={styles.card}>
            ...
            <ul className={styles.cardUl}>
              <li style={{ color: "#6C757D", fontWeight: "bold", }} className={styles.head}>
                KOOPERATIONEN
              </li>
              <div className={styles.line}></div>
        ...
        <div className={styles.picSlidder}>
          <Image src={imgicon} alt="img icon" width='95' height="109" />
        </div>
